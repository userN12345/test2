    ...
    <div class="py-1 bg-black top">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">{{App\Models\Setting_site::phone_site()}}</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">{{App\Models\Setting_site::email_site()}}</span>
					    </div>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container-fluid"style="width: 77%;">
	      <a class="navbar-brand" href="index.html">{{App\Models\Setting_site::title_site()}}</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="{{route('home_site')}}" class="nav-link">Home</a></li>
            
            @if ( Auth::user()->role == 'admin')
            <li class="nav-item"><a href="{{route('dashboard')}}" class="nav-link">Admin Page</a></li>
            @elseif(Auth::user()->role == 'supervisor')
            <li class="nav-item"><a href="{{route('meals')}}" class="nav-link">Admin Page</a></li>
            @endif 

            <li class="nav-item"><a href="{{route('my_reservation')}}" class="nav-link">My Reservation</a></li>
            
            <li class="nav-item"><a href="{{route('my_order')}}" class="nav-link">My Order</a></li>

            <li class="nav-item"><a href="{{route('complaints')}}" class="nav-link">Complaints</a></li>
           
            <li class="nav-item"><a href="{{route('cart_show')}}" class="nav-link">My Shopping Cart</a></li>


              <li class="nav-item "><a href="{{route('update_account')}}" class="nav-link">Edit Account</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                @foreach (App\Models\Category::get() as $categories)
                  <li class="nav-item "><a href="{{route('category',$categories->id)}}" style='color:#333;'class="nav-link">{{$categories->title}}</a></li>
                @endforeach
              </ul>
              
          </li>
          <li class="nav-item"><a href="{{route('logout_site')}}" class="nav-link">Logout</a></li>
